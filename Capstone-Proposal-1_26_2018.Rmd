...
The first task is to use R and Data Wrangling techniques to explore the data so to identify:
   a) Select the features to be used based on knowledge domain, and hypothesis derived directly from data observation 
   b) the most adequate classification techniques that can be used and 
   c) the data manipulations that need to be performed before applying the methods identified in a).
